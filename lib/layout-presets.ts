...
export const layoutPresets: LayoutPreset[] = [
  {
    ...
    layout: {
      ...
      gap: 16,
      cells: [
        { id: generateId(), row: 0, col: 0, rowSpan: 2, colSpan: 6 },
        { id: generateId(), row: 0, col: 6, rowSpan: 2, colSpan: 6 },
        { id: generateId(), row: 2, col: 0, rowSpan: 2, colSpan: 6 },
        { id: generateId(), row: 2, col: 6, rowSpan: 2, colSpan: 6 },
      ],
    },
  },
  {
    ...
    layout: {
      ...
      cells: [
        ...
        { id: generateId(), row: 0, col: 4, rowSpan: 2, colSpan: 4 },
        { id: generateId(), row: 0, col: 8, rowSpan: 2, colSpan: 4 },
      ],
    },
  },
  {
    ...
    layout: {
      ...
      gap: 16,
      cells: [
        { id: generateId(), row: 0, col: 0, rowSpan: 4, colSpan: 4 },
        { id: generateId(), row: 0, col: 4, rowSpan: 2, colSpan: 4 },
        { id: generateId(), row: 0, col: 8, rowSpan: 2, colSpan: 4 },
        { id: generateId(), row: 2, col: 4, rowSpan: 4, colSpan: 4 },
        { id: generateId(), row: 2, col: 8, rowSpan: 2, colSpan: 4 },
        { id: generateId(), row: 4, col: 0, rowSpan: 2, colSpan: 4 },
        { id: generateId(), row: 4, col: 8, rowSpan: 2, colSpan: 4 },
      ],
    },
  },
  {
    ...
    layout: {
      ...
      cells: [
        ...
        { id: generateId(), row: 0, col: 3, rowSpan: 2, colSpan: 3 },
        { id: generateId(), row: 0, col: 6, rowSpan: 2, colSpan: 3 },
        { id: generateId(), row: 0, col: 9, rowSpan: 2, colSpan: 3 },
        // Main content - large chart (col 0-9)
        { id: generateId(), row: 2, col: 0, rowSpan: 4, colSpan: 9 },
        // Sidebar widgets
        { id: generateId(), row: 2, col: 9, rowSpan: 2, colSpan: 3 },
        { id: generateId(), row: 4, col: 9, rowSpan: 2, colSpan: 3 },
      ],
    },
  },
  {
    ...
    layout: {
      ...
      cells: [
        // Hero - full width top
        { id: generateId(), row: 0, col: 0, rowSpan: 2, colSpan: 12 },
        // Feature cards below (3 cols, 4 units each)
        { id: generateId(), row: 2, col: 0, rowSpan: 2, colSpan: 4 },
        { id: generateId(), row: 2, col: 4, rowSpan: 2, colSpan: 4 },
        { id: generateId(), row: 2, col: 8, rowSpan: 2, colSpan: 4 },
      ],
    },
  },
  {
    ...
    layout: {
      ...
      cells: [
        ...
        { id: generateId(), row: 0, col: 0, rowSpan: 4, colSpan: 3 },
        // Main content area (col 3, 9 units)
        { id: generateId(), row: 0, col: 3, rowSpan: 2, colSpan: 9 },
        // Bottom content
        { id: generateId(), row: 2, col: 3, rowSpan: 2, colSpan: 6 },
        { id: generateId(), row: 2, col: 9, rowSpan: 2, colSpan: 3 },
      ],
    },
  },
